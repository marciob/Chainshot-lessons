...
const ALCHEMY_ENDPOINT = `https://eth-rinkeby.alchemyapi.io/v2/${PROVIDER_ENDPOINT}`;
...
const txParams = {
    ...
    "to": "0xfa5f2163762db7a31bc64d0ce48810d9e004d071", // choose someone to send some ETH to!
